...
function startGame() {
    myGamePiece = new component(30, 30, "img/bird.png", 10, 120, "image");
...
function updateGameArea() {
    ...
    for (i = 0; i < myObstacles.length; i += 1) {
        if (myGamePiece.crashWith(myObstacles[i])) {
            ...
            var t = document.createTextNode("Neu Starten");
            input.setAttribute("type", "text");
            input.setAttribute("id","name");
            btnsub.setAttribute("class", "btn btn-primary");
            btnsub.setAttribute("id","submit");
            btn.setAttribute("class","btn btn-primary");
            btn.setAttribute("onclick","javascript:window.location.reload();");
            btnsub.setAttribute("onclick", "hall();");
            btn.appendChild(t);
            btnsub.appendChild(sub);
